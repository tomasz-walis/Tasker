...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func configureCell(_ cell: CourseworkTableViewCell, withCoursework coursework: Coursework) {
        ...
        cell.cwName!.text = coursework.courseworkName
        cell.cwWeight!.text = "Weight: " + coursework.weight! + " %"
        cell.cwModuleName!.text = coursework.moduleName
        cell.cwLevel!.text = "Level: " + coursework.level!
        cell.cwDueDate!.text = "Due: " + coursework.date!
        cell.cwDaysLeft!.text = coursework.daysLeft
